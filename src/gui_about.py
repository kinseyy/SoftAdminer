...
class Ui_AboutWindow(QMainWindow):
    ...
    def retranslateUi(self):
        ...
        self.label_title.setText(QCoreApplication.translate("AboutWindow", "SoftAdminer"))
        self.label_version.setText(QCoreApplication.translate("AboutWindow", ""))
        self.label_copyright.setText(QCoreApplication.translate("AboutWindow", "Copyright") + " © 2022")
        self.label_author.setText(QCoreApplication.translate("AboutWindow", "Flame® Corporation"))
